...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='media/photo', blank=True, null=True, verbose_name='Изображение товара',
                              help_text='Загрузите изображение товара')
    category = models.ForeignKey("Category", on_delete=models.SET_NULL, verbose_name='Категория',
                                 help_text='Введите категорию', related_name="products", blank=True, null=True)
